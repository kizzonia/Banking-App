...
#  end
  ...
  def find_account
    ...
    def account_params
      params.require(:account).permit(:confirmed, :balance, :account_number, :first_name, :last_name, :phone_number, :ssn, :address, :dob, :routine_number, :user_id, :date_of_birth, :slug, :city, :zip_code, :country, :account_type, :account_pin, :verify_pin, :state, :image)
    end
end
